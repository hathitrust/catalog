...
<table cellpadding="2" cellspacing="0" border="0" class="citation" style="*width: auto">
  ...
  <tr valign="top">
    ...
    <td>
      ...
      {/foreach}
      {if $optoutList}
      Some items will not be scanned for HathiTrust Digital Library  <i><a class="dolightbox" href="#opt_out_items">more</a></i><p>
    </td>
  </tr>
  {/if}
    </td>
...
<!--div  class="overlay" id="opt_out_items" style="width:400px;height:200px;overflow:auto;"-->
<div  class="fancyboxInner" id="opt_out_items" style="text-align: left; width:400px; height:200px;">
  <p>Some items will not be scanned for HathiTrust Digital Library.  Specific items are listed below:</p>
  <table cellpadding="2" cellspacing="0" border="0" class="citation">
  {foreach from=$optoutList item=optout} 
    <tr>
      <td>{$optout.description}</td>
      <td>{$optout.barcode}</td>
    </tr>
  {/foreach}
  </table>
</div>
