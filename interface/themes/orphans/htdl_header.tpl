<div id="mbHeader" style="height: 80px">
  <div id="masthead">
    <div class="branding">
      <div class="brandingLogo">
        <a class="SkipLink" accesskey="2" href="#skipNav">Skip navigation</a>
        <h1 class="SkipLink">Hathi Trust Digital Library Orphan Works - {$pageTitle|truncate:64:"..."}</h1>
        <a href="/">
          <img src="/images/hathi/HathiTrust.gif" alt="Hathi Trust Logo" /><span>Digital Library &mdash; Orphan works candidates</span></a>
      </div>
    </div>  
...
{*
 {if $pageTitle eq 'Search Home'}
  ...
  <div id="SubNavHeader">
    <div id="SubNavHeaderCont">
      <div class="CollPage">
        <span>Orphan Works Candidates</span>
      </div>
    </div>
  </div>
  {/if}
