<div class="searchbox">
  <h3 class="SkipLink">Search or View Orphan Works</h3>
  <div class="yui-b" style="margin-left: 0em; *margin-left: 0em;">
  
    {if $suppress_searchbox}
      <!-- 
        <div style="margin: none; padding: none;">            
          <div style="margin-left: 5em; padding-bottom: 1em; padding-top: 0px">
    ...
    {else}  
      ...
      <form method="GET" id="searchForm" 
        ...
        <div id="searchGraphic">
          {*<img src="/images/hathi/SearchArrow_Cat.png" alt="Search Orphan Works"> *}
        ...
        <div id="searchboxCont">
           ...
           <!-- Index selection -->
            <span style="font-size: 120%; padding-top: 1em; padding-left: 18px; padding-right: 0.5em;">Search <a href="/">Orphan works candidates</a></span>
...
-->
     *}
           ...
           <div style="padding-top: 0.5em; margin-left: 18px"><em>If you are a bona fide copyright holder of any of these volumes, please
           contact us at the <a href="http://www.lib.umich.edu/orphan-works/copyright-holders">Orphan Works Project</a>.</em></div>  
         </div>
