  ...
  <div class="navbar navbar-static-top navbar-inverse" role="navigation">
    <div class="navbar-inner">
      ...
      <ul id="person-nav" class="nav pull-right">
        ...
        <li><a href="https://babel.hathitrust.org/cgi/mb?a=listcs;colltype=priv">My Collections</a></li>
        <li><a href="https://babel.hathitrust.org/cgi/logout">Logout</a></li>
      </ul>
      -->
    </div>
  </div>
      ...
      <form action="{$unicorn_root}/cgi/ls/one" method="GET">
        ...
        <div class="search-extra-options">
          <ul class="search-links">
            <li class="search-advanced-link"><a href="https://babel.hathitrust.org/cgi/ls?a=page;page=advanced">Advanced full-text search</a></li>
