            ...
            {/if}
              <div class="yui-ge">
                ...
                <div class="resultitem">
                  ...
                  {if $resource.author}
                  By: <a href="/Author/Home?author={$resource.author}">{$resource.author}</a><br>
                  {/if}
                  {if $resource.tags}
                  ...
                  {/if}
                  <img src="/images/{$resource.format|lower}-icon.gif" alt="{$resource.format}"> {$resource.format}
      ...
      <div class="box submenu">
        {if $user->cat_username}
          ...
          {foreach from=$transList item=item}
            <li>
              <img src="/images/{$item.format}" alt="{$item.format}">
              <a href="/Record/{$item.id}">{$item.title}</a><br>
