        ...
        <div class="yui-g first">
          <div class="yui-u first">
            ...
            <ul class="Browse" id="list1">
              ...
              <li class="active" style="float: none;"><a href="{$url}/Browse/LCC">{translate text="Call Number"}</a></li>
          ...
          <div class="yui-u" id="browse2">
            ...
            <ul class="Browse" id="list2">
              ...
              <li style="float: none;"><a href="" onClick="this.style.background='URL('+path+'/images/tab_active_bg.jpg)'; LoadOptions('callnumber-first:{$letter}', 'callnumber-label', 'list3', 'list4', 'callnumber'); return false;">{$letter} - {$area}</a></li>
              {/foreach}
            </ul>
            </div>
          </div>
