...
<p>APA and MLA are two commonly used citation formats.  Need help using another citation format? <a href="http://dev.www.lib.umich.edu/m/mobile-ask-a-librarian">Ask a Librarian</a></p>  
</div>