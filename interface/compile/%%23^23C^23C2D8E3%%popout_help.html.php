<?php /* Smarty version 2.6.21, created on 2012-03-21 11:54:45
         compiled from popout_help.html */ ?>
<!--  
...
<!--
  <div id="favorite_help" style="display: none">
    ...
    <p>Add to favorites” is Coming Soon!</p>

    <p>You’ll be able to mark a title as a private favorite and, if you want,  add other tags that you can use to sort your favorites later.
    </p>
  </div>
...
<!--  </div>
    ...
    <div id="searchhistory_help" style="display:none;" >
      ...
      <p>We’re still working on Search History.  We hope to have it available soon. Once it’s here, it will provide a list of your recent searches and allow you to revisit them within a browser session.</p>
...
<!--
    ...
    <div class="hd">Feedback</div>
      <h2>HathiTrust Catalog Feedback</h2>
            
      <form method="POST" id="feedbackform" action="mailto:hathitrust-info@umich.edu"      onsubmit="submitFeedback();return true;">
...
<div class="bd">
  <div class="gettingStarted_container">
    ...
    <span class="heading">Search</span>
      <p>
      <a href="http://hathi.vufind.lib.umich.edu">Catalog Search</a><br>
          Bibliographic search (Title, Author, Subject, ISBN/ISSN, Publisher, Series Title, or Year of Publication) of <em>all HathiTrust items</em>
          <br>
          <br>
          <a href="http://babel.hathitrust.org/cgi/ls">Experimental Search</a>
          <br>
          Full-text search of <em>a small subset of HathiTrust items</em>
       </p>
    </div>

    <div class="column2">
      <span class="heading">Build &amp; View Custom Collections</span>
      <p>
      Go to <a class="inline" target="_blank" href="http://babel.hathitrust.org/cgi/mb?a=listcs;colltype=pub">Public Collections </a> to browse other people's collections. Items from these collections can be copied into your own <a class="inline" target="_blank" href="http://babel.hathitrust.org/cgi/mb?a=listcs;colltype=priv">private collection</a>.
         <br>
         <br>
Create your own <a class="inline" target="_blank" href="http://babel.hathitrust.org/cgi/mb?a=listcs;colltype=priv">Private Collection</a> by searching or browsing to find items of interest and then adding them to a collection.
       </p>
     </div>
   </div>
       <div class="gettingStarted_middle">
         Full-text searching is available within <a class="inline" target="_blank" href="http://babel.hathitrust.org/cgi/mb?a=listcs;colltype=pub">public</a> or <a class="inline" target="_blank" href="http://babel.hathitrust.org/cgi/mb?a=listcs;colltype=priv">private collections</a>, and within individual items.
       </div>
<p align="right">
<a id="getStarted_close" href="#">
<strong>Close</strong>
</a>
</div>
...
<div id="emailThisRecord" align="left">
  <div class="bd">
  <?php if ($this->_tpl_vars['message']): ?><div class="error"><?php echo $this->_tpl_vars['message']; ?>
</div><?php endif; ?>

  <form action="<?php echo $this->_tpl_vars['url']; ?>
/Record/<?php echo $this->_tpl_vars['id']; ?>
/Email" method="post" id="popupForm" name="popupForm" onSubmit="SendEmail('<?php echo $this->_tpl_vars['id']; ?>
', this.elements['to'].value, this.elements['from'].value, this.elements['message'].value); return false;">
    ...
    <input id="emailRecord_close" type="submit" name="submit" value="Send">
  </form>
  </div>
</div>

<div id="emailThisSearch" align="left">
  <div class="bd">
  <?php if ($this->_tpl_vars['message']): ?><div class="error"><?php echo $this->_tpl_vars['message']; ?>
</div><?php endif; ?>

  <form action="<?php echo $this->_tpl_vars['url']; ?>
/Search/Email" method="post" onSubmit="SendEmail(this); return false;">
    ...
    <input id="emailSearch_close" type="submit" name="submit" value="Send">
  </form>
  </div>
</div>
...
<div id="export_help" style="display:none">
<h2>Export Record</h2>
<p>Exporting of records &mdash; to Endnote, Refworks, and possibly others &mdash; is currently being worked on and will be added
  as soon as possible.
</div>
...
<div style="display:none; text-align: left" id="searchtips_text">
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "searchtips.tpl", 'smarty_include_vars' => array()));
...
<div id="feedback_form" style="display:none">
  <div style="padding: 1.5em;" id="feedback_form_wrapper">
  <h2>Tell us what you think about the new HathiTrust Catalog!</h2>
  <form  method="POST" action="" onsubmit="SubmitFeedback(this); return false;">
    <table>
      <tr><td>Email</td><td><input name="uniqname" value="<?php echo $this->_tpl_vars['uniqname']; ?>
"><br>(only if you want a reply)</td></tr>
      <tr><td>Comment on:</td><td><input type="radio" name="url" value="none" checked="checked"> Whole site<br>
                                  <input id="feedback_url" type="radio" name="url" value="">Just this page</td></tr>
      <tr><td>Subject: </td><td><input name="subject" type="text" size="40"></td></tr>                            
      <tr><td>Your comment:</td><td><textarea name="comment" rows="8" cols="40"></textarea></td></tr>
      <tr><td></td><td><input type="submit" value="Submit your feedback"></td></tr>
    </table>
    
 </form>                                  

 <script language="JavaScript" type="text/javascript">
  jq('#feedback_url').val( window.location.href);
</script>
</div>  
</div>
-->
